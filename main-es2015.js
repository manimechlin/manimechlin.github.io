...
/* harmony import */ var _commonservice_auth_guard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./commonservice/auth.guard */ "./src/app/commonservice/auth.guard.ts");
...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | idealz-idealz-module */ "idealz-idealz-module").then(__webpack_require__.bind(null, /*! ./idealz/idealz.module */ "./src/app/idealz/idealz.module.ts")).then(m => m.IdealzModule)
    },
    {
        path: "login",
...
/* harmony import */ var _idealz_services_algorithm_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./idealz/services/algorithm.service */ "./src/app/idealz/services/algorithm.service.ts");
/* harmony import */ var _idealz_services_analysts_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./idealz/services/analysts.service */ "./src/app/idealz/services/analysts.service.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        ...
        providers: [
            _idealz_services_algorithm_service__WEBPACK_IMPORTED_MODULE_15__["AlgorithmService"],
            _idealz_services_analysts_service__WEBPACK_IMPORTED_MODULE_16__["AnalystsService"],
        ],
...
let AlgorithmService = class AlgorithmService {
    ...
    getAllAlgorithm() {
        ...
        return this.http
            .post(this.apiEndPoints.getAllAlgorithem, data, this.getHeaders())
            .pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('All Algorithm')));
    }
    deleteAlgorithem(id) {
        const data = {
            "algorithemId": id
        ...
        return this.http
            .post(this.apiEndPoints.deleteAlgorithem, data, this.getHeaders())
            .pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('Delete Algorithm')));
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AnalystsService", function() { return AnalystsService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _common_common_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./common/common.service */ "./src/app/idealz/services/common/common.service.ts");
/* harmony import */ var _url_url_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./url/url.service */ "./src/app/idealz/services/url/url.service.ts");
...
let AnalystsService = class AnalystsService {
    ...
    getAllAnalysts() {
        ...
        return this.http
            .post(this.apiEndPoints.getAllUserProfile, data, this.getHeaders())
            .pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('All ANALYSTS')));
    }
    addAnalyst(analyst) {
        ...
        return this.http
            .post(this.apiEndPoints.addAnalyst, data, this.getHeaders())
            .pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('ADD ANALYST')));
    }
    deleteAnalyst(id) {
        const data = {
            "userId": id,
        ...
        return this.http
            .post(this.apiEndPoints.deleteBlockUnBlockDeactivateUserProfile, data, this.getHeaders())
            .pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('Delete Analyst')));
    }
    blockAnalyst(id) {
        const data = {
            "userId": id,
        ...
        return this.http
            .post(this.apiEndPoints.deleteBlockUnBlockDeactivateUserProfile, data, this.getHeaders())
            .pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('Block Analyst')));
    }
    unBlockAnalyst(id) {
        const data = {
            "userId": id,
        ...
        return this.http
            .post(this.apiEndPoints.deleteBlockUnBlockDeactivateUserProfile, data, this.getHeaders())
            .pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('UnBlock Analyst')));
    }
    handleError(operation = 'operation', result) {
        return (error) => {
            // TODO: send the error to remote logging infrastructure
...
AnalystsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: "root"
    })
], AnalystsService);
...
/* harmony import */ var _url_url_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../url/url.service */ "./src/app/idealz/services/url/url.service.ts");
/* harmony import */ var _common_common_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../common/common.service */ "./src/app/idealz/services/common/common.service.ts");
/* harmony import */ var rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rxjs/internal/operators */ "./node_modules/rxjs/internal/operators/index.js");
/* harmony import */ var rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_5__);
