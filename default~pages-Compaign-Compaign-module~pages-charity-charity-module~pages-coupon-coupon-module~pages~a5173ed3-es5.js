(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-Compaign-Compaign-module~pages-charity-charity-module~pages-coupon-coupon-module~pages~a5173ed3"], {
  ...
  function srcAppIdealzPagesCompaignAddEditCompaignAddEditCompaignComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_idealz_services_prize_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! src/app/idealz/services/prize.service */
    "./src/app/idealz/services/prize.service.ts");
    /* harmony import */


    var src_app_idealz_services_product_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! src/app/idealz/services/product.service */
    "./src/app/idealz/services/product.service.ts");
    /* harmony import */


    var src_app_idealz_services_campaign_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
  ...
  /***/
  function srcAppIdealzServicesCampaignServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    let CampaignService = class CampaignService {
      ...
      campaignListing() {
        return this.http.get(this.apiEndPoints.campaignListing, this.getHeaders()).pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('productListing')));
      }

      getCampaign(id) {
        const data = new FormData();
        data.append('id', id);
        return this.http.post(this.apiEndPoints.getCampaign, data, this.getHeaders()).pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('Get Campaign')));
      }
      ...
      addCampaign(campaign) {
        ...
        return this.http.post(this.apiEndPoints.addCampaign, data, this.getHeaders()).pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('Add Campaign')));
      }
      ...
      deleteCampaign(id) {
        const data = new FormData();
        data.append('id', id);
        return this.http.post(this.apiEndPoints.deleteCampaign, data, this.getHeaders()).pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('Delete Campaign')));
      }
    ...
    CampaignService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: "root"
    })], CampaignService);
    /***/
  },
  ...
  function srcAppIdealzServicesPopupPopupServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _pages_inventory_edit_inventory_edit_inventory_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ../../pages/inventory/edit-inventory/edit-inventory.component */
