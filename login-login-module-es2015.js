...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("form.user .btn-user {\n  padding: 0.75rem 4rem !important;\n  margin: auto !important;\n}\n\n.btn-block {\n  width: auto !important;\n}\n\n/* You can add global styles to this file, and also import other style files */\n/*# sourceMappingURL=data:application/json;base64, */");
...
let LoginComponent = class LoginComponent {
    ...
    login() {
        this.api.singIn(this.loginBody).subscribe(res => {
            console.log(res);
            if (res.status === 1) {
                this.api.setUser(JSON.stringify(res));
                this.api.sendToken(res.data.auth_token);
            ...
            if (res.status === 3) {
                this.toastr.errorToastr(res.uiMessage, '', {
                    maxShown: 1
                });
