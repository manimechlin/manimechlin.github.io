(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-prize-prize-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppIdealzPagesPrizeAddPrizeAddPrizeComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppIdealzPagesPrizePrizePrizeComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppIdealzPagesPrizeAddPrizeAddPrizeComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppIdealzPagesPrizeAddPrizeAddPrizeComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AddPrizeComponent", function () {
      return AddPrizeComponent;
    });
    /* harmony import */
    ...
    var src_app_idealz_services_prize_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! src/app/idealz/services/prize.service */
    ...
    let AddPrizeComponent = class AddPrizeComponent {
      ...
      ngOnInit() {
        this.productForm = this.formBuilder.group({
          ...
          specifications: this.formBuilder.array([this.formBuilder.group({
            ...
            arabicValue: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]
          })]),
    ...
    AddPrizeComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-add-prize',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./add-prize.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/idealz/pages/prize/add-prize/add-prize.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./add-prize.component.scss */
      "./src/app/idealz/pages/prize/add-prize/add-prize.component.scss")).default]
    })], AddPrizeComponent);
    /***/
  },
  ...
  /***/
  function srcAppIdealzPagesPrizePrizeRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PrizeRoutingModule", function () {
      return PrizeRoutingModule;
    });
    /* harmony import */
    ...
    var _prize_prize_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./prize/prize.component */
    "./src/app/idealz/pages/prize/prize/prize.component.ts");
    /* harmony import */


    var _add_prize_add_prize_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./add-prize/add-prize.component */
    "./src/app/idealz/pages/prize/add-prize/add-prize.component.ts");
    ...
    PrizeRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppIdealzPagesPrizePrizeModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PrizeModule", function () {
      return PrizeModule;
    });
    /* harmony import */
    ...
    var _prize_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./prize-routing.module */
    "./src/app/idealz/pages/prize/prize-routing.module.ts");
    /* harmony import */
    ...
    PrizeModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _prize_routing_module__WEBPACK_IMPORTED_MODULE_5__["PrizeRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"]]
    })], PrizeModule);
    /***/
  },
  ...
  /***/
  function srcAppIdealzPagesPrizePrizePrizeComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppIdealzPagesPrizePrizePrizeComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PrizeComponent", function () {
    ...
    var src_app_idealz_services_prize_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/app/idealz/services/prize.service */
    "./src/app/idealz/services/prize.service.ts");
    /* harmony import */
    ...
    PrizeComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-prize',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./prize.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/idealz/pages/prize/prize/prize.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./prize.component.scss */
      "./src/app/idealz/pages/prize/prize/prize.component.scss")).default]
    })], PrizeComponent);
    /***/
  },
  ...
  /***/
  function srcAppIdealzServicesPrizeServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PrizeService", function () {
      return PrizeService;
    });
    /* harmony import */
    ...
    let PrizeService = class PrizeService {
      ...
      prizeListing() {
        return this.http.get(this.apiEndPoints.prizeListing, this.getHeaders()).pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('productListing')));
      }
      ...
      addPrize(prize) {
        ...
        prize.specifications.forEach((spec, i) => {
          data.append("specifications[".concat(i, "][name]"), spec.name);
          data.append("specifications[".concat(i, "][value]"), spec.value);
          data.append("specifications[".concat(i, "][arabic_name]"), spec.arabicName);
          data.append("specifications[".concat(i, "][arabic_value]"), spec.arabicValue);
        });
        return this.http.post(this.apiEndPoints.addPrize, data, this.getHeaders()).pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('Add Product')));
      }

      deletePrize(id) {
        const data = new FormData();
        data.append('id', id);
        return this.http.post(this.apiEndPoints.deletePrize, data, this.getHeaders()).pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('Delete Prize')));
      }
    ...
    PrizeService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: "root"
    })], PrizeService);
    /***/
  }
}]);
//# sourceMappingURL=pages-prize-prize-module-es5.js.map